...
const Payment = () => {
  ...
  const [paymentamount, setPaymentamount] = useState<number>(449);
  ...
  useEffect(() => {
    ...
    setPaymentAmount(isNaN(amount) ? 29 : amount);
  }, [location]);
  ...
  const handleDownload = () => {
    ...
    link.download = 'DSA-Handwritten-Notes.pdf';
    ...
    <div className="min-h-screen flex justify-center items-center bg-[#f9f9f9] px-4 py-10">
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-md flex flex-col md:flex-row p-8 gap-10">\
        ...
        <div className="w-full md:w-1/2">
          <h3 className="text-2xl font-bold">Data Structures and Algorithms Handwritten Notes</h3>

          <p className="mt-3 text-gray-600 text-base">
            These notes are perfect for mastering DSA concepts for interviews and competitive exams. Clear, concise, and made for revision — just what you need to strengthen your core.
          </p>
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            >
              Pay ₹{paymentAmount} and Get DSA Notes
            </button>
          </form>
        </div>
