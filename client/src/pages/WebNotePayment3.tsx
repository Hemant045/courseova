...
const Payment = () => {
  ...
  const [paymentamount, setPaymentamount] = useState<number>(399);
  const [qrImage, setQrImage] = useState('/images/paymentQR.jpg');
  const [upiId, setUpiId] = useState('9257372495@axl');

  useEffect(() => {
    const params = new URLSearchParams(location.search);
    const amount = parseFloat(params.get('amount') || '19');
    setPaymentAmount(isNaN(amount) ? 19 : amount);
  }, [location]);
  ...
  const handleDownload = () => {
    ...
    link.href = 'https://drive.google.com/uc?export=download&id=1kVNl_mfmNFgg0l4RjJ3qSTPxDb_BYYKT'; // Ensure this path exists in your public folder
    link.download = 'SQL-Handwritten-Notes.pdf';
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-[#f9f9f9] px-4 py-10">
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-md flex flex-col md:flex-row p-8 gap-10">
        ...
        {/* Left: Info (SQL Version) */}
        <div className="w-full md:w-1/2">
          <h3 className="text-2xl font-bold">SQL Complete Course Notes</h3>

          <p className="mt-3 text-gray-600 text-base">
            Access concise and easy-to-understand handwritten SQL notes, perfect for both beginners and those preparing for interviews or exams. Strengthen your database concepts efficiently!
          </p>
          ...
          <ul className="mt-4 text-gray-700 text-base list-disc list-inside space-y-1">
            ...
            <li>Constraints & Normalization</li>
            <li>DDL, DML, DCL & TCL Commands</li>
            <li>Indexes & Views</li>
            <li>Stored Procedures & Functions</li>
            <li>Triggers & Transactions</li>
            <li>Real-world SQL Scenarios & Interview Questions</li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            >
              Pay ₹{paymentAmount} and Get Notes
            </button>
          </form>
        </div>
...
// https://drive.google.com/file/d/1kVNl_mfmNFgg0l4RjJ3qSTPxDb_BYYKT/view?usp=sharing